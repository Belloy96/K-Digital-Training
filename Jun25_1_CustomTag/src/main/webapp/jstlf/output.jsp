...
<body>
	...
	<hr>
	<fmt:formatDate value="${d }" type="date" dateStyle="short"/> → short
	<br>
	<fmt:formatDate value="${d }" type="date" dateStyle="long"/> → long
	<hr>
	<fmt:formatDate value="${d }" type="time" timeStyle="short"/> → short
	<br>
	<fmt:formatDate value="${d }" type="time" timeStyle="long"/> → long
	<hr>
